                    ...
                    <View style={styles.cv_content}>
                        <View style={{ ...styles.profile }}>
                            <View style={styles.profile_image_container}>
                                <Image style={styles.profile_img} src={`http://3.110.201.2:3002/${cv_data.cv_image.replace("images", "images/")}`} />
                            </View>
                        ...
                        <View style={styles.info_grid}>
                            ...
                            <View style={styles.right_column}>
                                ...
                                <Image src={`http://3.110.201.2:3002/${cv_data.passport_photo.replace("images", "images/")}`} />
                            </View>
                        </View>
                    </View>
                </Page>
