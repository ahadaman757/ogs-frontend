...
const Personalinfo = ({}) => {
  ...
  return (
    <div className="row">
      <form
        onSubmit={ResetProfileFormik.handleSubmit}
        className={` p-4 mb-4 ${Styles.Personalinfomain}`}
      >
        ...
        <div className="row">
          <div className="col-md-6">
            ...
            <List
              id="position"
              options={employerRegsiterOptions?.positions}
              label="Position"
              formik={ResetProfileFormik}
            />
            <List
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="d-flex my-3 justify-content-end">
              <button
                onClick={ResetProfileFormik.resetForm}
                className={`me-3 ${Styles.profcbtn}`}
              >
                Cancel
              </button>
              <button type="submit" className={`me-2 ${Styles.profsbtn}`}>
                Save
              </button>
            </div>
          </div>
