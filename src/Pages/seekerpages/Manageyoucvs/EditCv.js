    ...
    const CvFormIk = useFormik(
        {
            ...
            onSubmit: values => {
                ...
                axios.post('http://3.110.201.21:3002/update_cv', formdata, {
                    headers: {
                ...
                Asterisk (*) indicates required field
                            ...
                            <div className={`row`}>
                                ...
                                <div className="col-md-6">
                                    ...
                                    {
                                        !CvImage && <img className={`border-round ${styles.cv_update_img} `} src={`http://3.110.201.21:3002/${cv_data.cv_image.replace("images", "images/")}`} />
                                    }
                                ...
                                <div className="col-md-6">
                                    ...
                                    {
                                        !CvPassportImage && <img className={`border-round ${styles.cv_update_img} `} src={`http://3.110.201.21:3002/${cv_data.passport_photo.replace("images", "images/")}`} />
                                    }
