import Styles from './sendnewsletterseekers.module.css';
                ...
                <div className="col-md-5 me-3">
                  ...
                  <div className="d-flex justify-content-start">
                    ...
                    <button
                      ...
                      onClick={() => {
                        axios.post(
                          'https://3.110.201.21:3002/admin/addNewsSeeker',
                          {
                            data: editorData,
                          },
                          {
...
export default Sendnewsletterseekers;
