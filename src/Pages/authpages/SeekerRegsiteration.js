    ...
    return (
        <div className=''>
            ...
            <form className='row' onSubmit={signupFormIk.handleSubmit}>
                ...
                <div class="col-12">
                    <TextInput type="email" id='email' formik={signupFormIk} label="Email" />
                </div>
                <div class="col-md-6">
                    <TextInput type="password" id='password' formik={signupFormIk} label="Password" />
                </div>
                <div class="col-md-6">
                    <TextInput type="password" id='repeatPassword' formik={signupFormIk} label="Repeat Password" />
                </div>
                {
                    signupError && <p className='text-danger'>
                        {signupError}
                    </p>
                }
                {
...
function SeekerRegisteration() {
    return (
        <div className={`${styles.auth_page} py-5   d-flex flex-column  container-fluid px-md-5  primary-bg`}>
